// Copyright (c) 2015, the SoD project authors.
//
...
//
// Adapted to run in SoD by the SoD authors in 2015.
//
...
// Rice University, 1997. The algorithm itself is an extension to the
// algorithm described R.E. Tarjan, 1974, Testing flow graph reducibility. 
// It further employs the Union/Find algorithm described in "Union/Find
// Algorithm", Tarjan, R.E., 1983, Data Structures and Network Algorithms.

import "dart:collection";

main() {
  return new Havlak().run();
}
...
class Havlak {
  ...
  int run() {
    ...
    if (numLoops != 1522) {
      print("Wrong result - expected 1522, but was $numLoops");
      return 1;
    }
    return 0;
  }
